(function () {
  ...
  // correction (stays at 1) rather than being silently dropped — same
  ...
  function buildBinEditor(key, body) {
    ...
    p.textContent =
      "Looks numeric. Set where each bracket starts — the label to the right updates on its own. Removing a bracket merges its range into the one above it.";
    wrap.appendChild(p);
